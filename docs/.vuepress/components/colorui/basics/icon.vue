  ...
  <div>
    <div class="cu-bar bg-white search">
      <div class="search-form round">
        ...
        <input type="text" v-model="name" placeholder="搜索cuIcon" confirm-type="search" @input="searchIcon"></input>
      </div>
    </div>
    <div class="cu-list grid col-3">
      <div class="cu-item" v-for="(item,index) in cuIcon" :key="index" v-if="item.isShow">
        <span class="lg text-gray" :class="'cuIcon-' + item.name"></span>
        <span>{{item.name}}</span>
      </div>
    </div>
  </div>
...
<style scoped>
  @import url('../../../../../public/colorui/icon.css');
</style>
