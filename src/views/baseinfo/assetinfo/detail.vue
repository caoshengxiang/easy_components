      ...
      <div class="createPost-main-container">
            <div class="postInfo-container">
              <el-row style="margin-left: 150px">
                <el-col :span="8">
                  <el-form-item label="土地产权：" prop="type" label-width="200px" class="postInfo-container-item ">
                    <el-select v-if="type=='add'" v-model="postForm.type" placeholder="土地产权" clearable class="filter-item " style="width: 100%">
              ...
              <el-row style="margin-left: 150px">
                <el-col :span="8">
                  <el-form-item label=" 所在校区："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-select v-if="type=='add'" v-model="postForm.type" placeholder="所在校区" clearable class="filter-item" style="width: 100%">
                      <el-option key="1" label="男" value="1" />
                      <el-option key="2" label="女" value="2" />
                    </el-select>
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
                ...
                <el-col :span="8">
                  <el-form-item label="土地用途："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-select v-if="type=='add'" v-model="postForm.type" placeholder="土地用途" clearable class="filter-item" style="width: 100%">
                      <el-option key="1" label="男" value="1" />
                      <el-option key="2" label="女" value="2" />
                    </el-select>
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
              ...
              <el-row style="margin-left: 150px">
                <el-col :span="8">
                  <el-form-item label="土地面积（平方米）："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-input v-if="type=='add'" v-model="postForm.type"   class="filter-item" />
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="土地证号："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-input v-if="type=='add'" v-model="postForm.type"   class="filter-item" />
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
                  </el-form-item>
                </el-col>
              ...
              <el-row style="margin-left: 150px">
                <el-col :span="8">
                  <el-form-item label="土地价格（万元）："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-input v-if="type=='add'" v-model="postForm.type"   class="filter-item" />
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
                  </el-form-item>
                </el-col>
              ...
              <el-row style="margin-left: 150px">
                <el-col :span="12">
                  <el-form-item label="用地地址："  prop="type" label-width="200px" class="postInfo-container-item">
                    <el-input v-if="type=='add'" v-model="postForm.type"   class="filter-item" />
                    <el-input v-else v-model="postForm.type" disabled  class="filter-item" />
                  </el-form-item>
                </el-col>
