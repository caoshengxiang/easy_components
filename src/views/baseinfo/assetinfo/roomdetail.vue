          ...
          <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container"  style="padding-right: 15% ">
            <div class="createPost-main-container">
              <div class="postInfo-container">
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="建筑物：" prop="type" label-width="200px" class="postInfo-container-item ">
                      <el-select v-model="postForm.constructionId" default-value="0" placeholder="所属建筑物" clearable  class="filter-item"  style="width: 100%">
                ...
                <el-row >
                  <el-col :span="8">
                    <el-form-item label="网络状态："  prop="networkCondition" label-width="200px" class="postInfo-container-item">
