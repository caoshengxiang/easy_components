<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-top: 10px;float: left">
      ...
      <el-select v-model="listQuery.importance" placeholder="使用机构" clearable style=" width: 200px" class="filter-item">
        <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item" />
      </el-select>
    </div>
    <div class="filter-container" style="margin-top: 10px;float: right">
      <el-input v-model="listQuery.description" placeholder="实训室名称" prefix-icon="el-icon-search"  style="margin-left: 20px;width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column label="实训室名称" prop="id" sortable="custom" align="center" width="150">
      ...
      <el-table-column label="教室" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.timestamp | parseTimeNew('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="实训室类别" min-width="150px"  align="center">
        <template slot-scope="{row}">
          <span>{{ row.title }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="使用机构"  width="110px" align="center">
        <template slot-scope="{row}">
