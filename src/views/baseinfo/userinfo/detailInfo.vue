        ...
        <el-tabs v-model="activeName" type="border-card" style="width: 100%" @tab-click="handleClick" >
          ...
          <el-tab-pane label="基本信息" name="first">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="所属派出所："  prop="belongPoliceStation" label-width="120px" class="postInfo-container-item">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="是否随迁子女："  prop="ifTrailingChildren" label-width="120px" class="postInfo-container-item">
          ...
          <el-tab-pane label="班级信息" name="second">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="专业："  prop="administrativeSpecialtyId" label-width="120px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                ...
                <el-form-item label="班级："  prop="administrativeClbumId" label-width="120px" class="postInfo-container-item">
          ...
          <el-tab-pane label="生源及其他信息" name="third">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="籍贯地行政区划码："  prop="nativePlaceCode" label-width="250px" class="postInfo-container-item">
                  <el-input    v-model="postForm.nativePlaceCode"   class="filter-item" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="出生地行政区划码："  prop="birthPlaceCode" label-width="150px" class="postInfo-container-item">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="户口所在地区县以下详细地址："  prop="registerAddr" label-width="250px" class="postInfo-container-item">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="联招合作办学形式："  prop="educationForm" label-width="250px" class="postInfo-container-item">
              ...
              <el-col :span="8">
                <el-form-item label="联招合作学校代码："  prop="educationSchoolCode" label-width="250px" class="postInfo-container-item">
          ...
          <el-tab-pane label="家庭成员及监护人信息" name="fourth">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="成员1关系："  prop="memberRelationship" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员1是否监护人："  prop="memberGuardian" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员1出生年月："  prop="memberBirthday" label-width="150px" class="postInfo-container-item">
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="成员1证件类型："  prop="memberCertificationType" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员1政治面貌："  prop="memberPoliticsStatus" label-width="150px" class="postInfo-container-item">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="成员1工作或学习单位："  prop="memberWorkUnit" label-width="170px" class="postInfo-container-item">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="成员2关系："  prop="memberRelationship2" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员2是否监护人："  prop="memberGuardian2" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员2出生年月："  prop="memberBirthday2" label-width="150px" class="postInfo-container-item">
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="成员2证件类型："  prop="memberCertificationType2" label-width="150px" class="postInfo-container-item">
              ...
              <el-col :span="6">
                <el-form-item label="成员2政治面貌："  prop="memberPoliticsStatus2" label-width="150px" class="postInfo-container-item">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="成员2工作或学习单位："  prop="memberWorkUnit2" label-width="170px" class="postInfo-container-item">
