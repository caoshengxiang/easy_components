  ...
  <div class="assetinfo-detail app-container">
    ...
    <y-detail-page-layout @save="save" saveBtnName="打印">
      <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container postInfo-container"
               style="position: relative;padding: 1px 20px;width: 1100px;margin: auto;"
               id="studentInfo"
      >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="学籍号：" prop="studentCode" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.studentCode" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="学号：" prop="studyCode" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.studyCode" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="姓名：" prop="name" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.name" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="姓名拼音：" prop="spell" label-width="150px" class="postInfo-container-item">
          ...
          <el-col :span="8">
            <el-form-item label="性别：" prop="type" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.sex" placeholder="" clearable class="filter-item" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="证件类型：" prop="certificateType" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.certificateType" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="联系电话：" prop="mobile" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.mobile" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="国籍/地区：" prop="country" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.country" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="港澳台侨外：" prop="compatriot" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.compatriot" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="婚姻状况：" prop="maritalStatus" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.maritalStatus" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="民族：" prop="nation" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.nation" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="联招合作类型：" prop="recruitType" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.recruitType" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="入学方式：" prop="entryType" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.entryType" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="英文姓名：" prop="englishName" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.englishName" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="所属派出所：" prop="belongPoliceStation" label-width="150px"
          ...
          <el-col :span="8">
            <el-form-item label="学生类别：" prop="cate" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.cate" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="就读方式：" prop="studyWay" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.studyWay" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="学习形式：" prop="studyStyle" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.studyStyle" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="当前状态：" prop="state" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.state" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="乘火车区间：" prop="railwayRange" label-width="150px" class="postInfo-container-item">
              <el-input v-model="postForm.railwayRange" class="filter-item"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否随迁子女：" prop="ifTrailingChildren" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.ifTrailingChildren" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="分段培养方式：" prop="cultivateModel" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.cultivateModel" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="学生类型：" prop="studentType" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.studentType" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="年级：" prop="administrativeGradeId" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.administrativeGradeId" placeholder="" clearable
          ...
          <el-col :span="8">
            <el-form-item label="专业：" prop="administrativeSpecialtyId" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.administrativeSpecialtyId" placeholder="" clearable class="filter-item"
                         style=" width: 200px"
              >
          ...
          <el-col :span="8">
            ...
            <el-form-item label="班级：" prop="administrativeClbumId" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.administrativeClbumId" placeholder="" clearable class="filter-item"
                         style="width: 200px"
              >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="年级：" prop="schoolGradeId" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.schoolGradeId" placeholder="" clearable style="margin-left:10px;"
                         class="filter-item"
              >
                <el-option v-for="item in classInfo" :key="item.id" :label="item.name" :value="item.id"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="专业：" prop="schoolSpecialtyId" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.schoolSpecialtyId" placeholder="" clearable class="filter-item"
                         style=" width: 200px"
              >
                <el-option v-for="item in majorInfo" :key="item.id" :label="item.name" :value="item.id"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="班级：" prop="schoolClbumId" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.schoolClbumId" placeholder="" clearable class="filter-item"
                         style="width: 200px"
              >
                <el-option v-for="item in gradeInfo" :key="item.id" :label="item.name" :value="item.id"/>
              </el-select>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="户口地址信息：" prop="countyName" label-width="150px" class="postInfo-container-item">
              <el-cascader
                :options="areasls"
          ...
          <el-col :span="12">
            <el-form-item label="籍贯地行政区划码：" prop="nativePlaceCode" label-width="210px"
                          class="postInfo-container-item"
            >
          ...
          <el-col :span="12">
            <el-form-item label="户口所在地区县以下详细地址：" prop="registerAddr" label-width="210px"
                          class="postInfo-container-item"
            >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="联招合作办学形式：" prop="educationForm" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.educationForm" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="联招合作学校代码：" prop="educationSchoolCode" label-width="150px"
                          class="postInfo-container-item"
            >
        ...
        <div style="margin-top:160px;width:100%;height:1px;background:rgba(242,242,242,1);"/>
        <div style="margin-bottom: 30px">
          <h3 class="title">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="成员1关系：" prop="memberRelationship" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberRelationship" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
          ...
          <el-col :span="8">
            <el-form-item label="成员1是否监护人：" prop="memberGuardian" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberGuardian" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in opt" :key="item.key" :label="item.label" :value="item.key"/>
              </el-select>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="成员1证件类型：" prop="memberCertificationType" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberCertificationType" placeholder="" clearable
          ...
          <el-col :span="8">
            <el-form-item label="成员1民族：" prop="memberNation" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.memberNation" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in AllEnum.民族" :key="item" :label="item" :value="item"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="成员1政治面貌：" prop="memberPoliticsStatus" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberPoliticsStatus" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="成员1健康状况：" prop="memberHealth" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.memberHealth" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="成员2关系：" prop="memberRelationship2" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberRelationship2" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in AllEnum.关系" :key="item" :label="item" :value="item"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="成员2是否监护人：" prop="memberGuardian2" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberGuardian2" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in opt" :key="item.key" :label="item.label" :value="item.key"/>
              </el-select>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="成员2证件类型：" prop="memberCertificationType2" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberCertificationType2" placeholder="" clearable
                         class="filter-item" style="width: 100%"
              >
                <el-option v-for="item in AllEnum.证件类型" :key="item" :label="item" :value="item"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="成员2民族：" prop="memberNation2" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.memberNation2" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in AllEnum.民族" :key="item" :label="item" :value="item"/>
              </el-select>
          ...
          <el-col :span="8">
            <el-form-item label="成员2政治面貌：" prop="memberPoliticsStatus2" label-width="150px"
                          class="postInfo-container-item"
            >
              <el-select v-model="postForm.memberPoliticsStatus2" placeholder="" clearable
                         class="filter-item" style="width: 100%"
              >
                <el-option v-for="item in AllEnum.政治面貌" :key="item" :label="item" :value="item"/>
              </el-select>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="成员2健康状况：" prop="memberHealth2" label-width="150px" class="postInfo-container-item">
              <el-select v-model="postForm.memberHealth2" placeholder="" clearable class="filter-item"
                         style="width: 100%"
              >
                <el-option v-for="item in AllEnum.健康状况" :key="item" :label="item" :value="item"/>
              </el-select>
    ...
    methods: {
      ...
      save() {
        if (this.postForm.name) {
          printPdf('#studentInfo', this.postForm.name + '-' + this.postForm.memberIdNo)
        }
      },
    }
  }
