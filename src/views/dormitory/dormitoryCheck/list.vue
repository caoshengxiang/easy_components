<template>
  <div class="app-container">
    ...
    <y-page-list-layout :pageList="pageData" :pagePara="pagePara" :getPageList="getList">
      <template slot="left">
        <el-button class="filter-item" style="margin-left: 0px;" round type="primary" icon="el-icon-plus"
                   @click="handleCreate"
        >
          新增周宿舍考核
        </el-button>
      ...
      <template slot="right">
        ...
        <el-button class="filter-item download-button" round type="primary" @click="handleCreate">
          导出宿舍考核
        </el-button>
        <el-button class="filter-item download-button" round type="primary" @click="handleCreate">
          导出当天宿舍得分
