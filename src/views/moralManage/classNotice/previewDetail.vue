  ...
  <div class="classNotice-detail app-container">
    ...
    <div class="page-layout">
      ...
      <div class="content-wrapper">
        <div>
          <span style="font-weight: bolder">{{info.studentName}} </span>家长同志：
        </div>
        <div>
          <p>根据上级教育部门的通知精神，本期我校学生放假离校时间为1月9号。下期开学报到时间，一、二年级为2月9号，三年级为2月3号，现将有关注意事项通知于后，希望家长同志密切配合，使学生度过一个充实愉快、健康有益的假期。</p>
