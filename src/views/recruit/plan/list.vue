    ...
    <div class="statisticsInfo">
      <div class="menu-2-box">
        <div class="menu-2-item hvr-underline-from-center">
          ...
          <div class="text">
            <div class="analysis-text">
              <span class="tag">{{ statisticsInfo.planCount }}</span>人
            </div>
        ...
        <div class="menu-2-item hvr-underline-from-center">
          ...
          <div class="text">
            <div class="analysis-text">
              <span class="tag">{{ statisticsInfo.preCount }}</span>人
            </div>
        ...
        <div class="menu-2-item hvr-underline-from-center">
          ...
          <div class="text">
            <div class="analysis-text">
              <span class="tag">{{ statisticsInfo.regCount }}</span>人
            </div>
    ...
    <y-page-list-layout :pageList="pageData" :pagePara="listQuery" :getPageList="getList">
      <template slot="left">
        ...
        <el-button
          ...
          @click="getList"
        >搜索</el-button>
        <el-button class="filter-item" round type="warning" @click="resetSearch()">重置</el-button>
      </template>
      <template slot="right" />
...
export default {
  ...
  methods: {
    getStatistics() {
      let that = this;
      that.$api.statistics
        .getStatistics("/admissionPlan/pageStatics", { ...that.listQuery })
        .then((data) => {
          that.loading = false;
          if (data.code === 200) {
    ...
    getList() {
      ...
      this.$api.plan
        .list({ ...that.listQuery, ...that.pagePara })
        .then((res) => {
