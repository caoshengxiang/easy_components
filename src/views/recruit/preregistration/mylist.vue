<template>
  <div class="app-container">
    ...
    <y-page-list-layout :pageList="pageData" :pagePara="pagePara" :getPageList="getList">
      <template slot="left">
        <PermissionButton
          menu-no="_views_recruit_preregistration_detail1"
      ...
      <parentTable v-loading="listLoading" :data="pageData.records" @sortTable="sortTable" slot="table" style="width:100%" >
        ...
        <el-table-column label="操作" align="center" width="220">
          <template slot-scope="{row}">
            <PermissionButton
              menu-no="_views_recruit_preregistration_edit1"
              type="primary"
              name=""
              :page-jump="true"
            ...
            <PermissionButton
              v-if="row.feeState == 1"
              menu-no="_views_recruit_preregistration_remove1"
              type="danger"
              name=""
            ...
            />
            <PermissionButton
              menu-no="_views_recruit_preregistration_print1"
              type="success"
              name=""
              :page-jump="true"
              :page-query="{id: row.id}"
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$api.admiisionPreApply.mylist({ ...that.listQuery, ...that.pagePara }).then(res => {
