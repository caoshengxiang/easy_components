            ...
            <div class="createPost-main-container">
              <div class="postInfo-container">
                ...
                <el-row>
                  ...
                  <el-col :span="12" :lg="8">
                    <el-form-item label="占地面积其中绿化用地面积" class="postInfo-container-item">
                ...
                <div style="margin-bottom: 30px">
                  <h3 class="title">
                    ...
                    <div class="icon-info">生活用房(平方米)</div>
                  </h3>
                </div>
                <el-row>
                  <el-col :span="12" :lg="8">
                ...
                <el-row>
                  ...
                  <el-col :span="12" :lg="8">
                    <el-form-item label="计算机数（台）其中教学用计算机" class="postInfo-container-item">
                      <el-input v-model="postForm.TEACHING_COMPUTER.value" class="filter-item"/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12" :lg="8">
                    <el-form-item label="计算机数（台）其中机房用计算机公共机房" class="postInfo-container-item">
                ...
                <el-row>
                  <el-col :span="12" :lg="8">
                    <el-form-item label="计算机数（台）其中机房用计算机专业机房" class="postInfo-container-item">
                ...
                <el-row>
                  ...
                  <el-col :span="12" :lg="8">
                    <el-form-item label="教室（间）其中网络多媒体教室数" class="postInfo-container-item">
                ...
                <div style="margin-bottom: 30px">
                  <h3 class="title">
                    <div class="avatar-wrapper icon-title" style="background:rgb(105,135,176)">数</div>
                ...
                <div style="margin-bottom: 30px">
                  <h3 class="title">
                    <div class="avatar-wrapper icon-title" style="background:rgb(154,152,161)">固</div>
                ...
                <el-row>
                  ...
                  <el-col :span="12" :lg="8">
                    <el-form-item label="其中教学、实习仪器设备资产值资产总值" class="postInfo-container-item">
                      <el-input v-model="postForm.TEACHING_ASSET.value" class="filter-item"/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12" :lg="8">
                    <el-form-item label="其中教学、实习仪器设备资产值当年新增资产值" class="postInfo-container-item">
