        ...
        <el-tab-pane label="请假信息录入" name="first">
          ...
          >
            <div class="createPost-main-container">
              <div style="font-size: 20px;font-weight: 500;text-align: center;padding-left: 100px;margin-bottom: 20px">{{ this.configInfo.SCHOOL_NAME.value }}<lable style="color: red">{{postForm.leaveStudyYear}}</lable> 学年  <lable style="color: red">{{term.name}}</lable> 学生请假单</div>
